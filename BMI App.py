...
if halaman == "Kalkulator BMI":
    ...
    with col1:
        berat_badan = st.number_input("Berat Badan (kg)", min_value=0.0, value=0.0, step=0.1)
...
# ===========================
    ...
    with col2:
        ...
        lingkar_pinggang = st.number_input("Lingkar Pinggang (cm)", min_value=0, value=0.0, step=0.1)
        lingkar_leher = st.number_input("Lingkar Leher (cm)", min_value=0, alue=0.0, step=0.1)
